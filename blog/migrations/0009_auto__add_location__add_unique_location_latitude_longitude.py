...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'blog_location', (
        ...
        # Adding unique constraint on 'Location', fields ['latitude', 'longitude']
        db.create_unique(u'blog_location', ['latitude', 'longitude'])


    def backwards(self, orm):
        # Removing unique constraint on 'Location', fields ['latitude', 'longitude']
        db.delete_unique(u'blog_location', ['latitude', 'longitude'])

        # Deleting model 'Location'
        db.delete_table(u'blog_location')
    ...
    models = {
        ...
        u'blog.location': {
            'Meta': {'unique_together': "(('latitude', 'longitude'),)", 'object_name': 'Location'},
