...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogCategory.description'
        db.add_column(u'blog_blogcategory', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlogCategory.description'
        db.delete_column(u'blog_blogcategory', 'description')
    ...
    models = {
        ...
        u'blog.blogpost': {
            ...
            'description': ('django.db.models.fields.CharField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'blogposts'", 'null': 'True', 'to': u"orm['blog.Location']"}),
