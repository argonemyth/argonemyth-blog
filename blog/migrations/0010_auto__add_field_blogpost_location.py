...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'blog_blogpost', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='blogposts', null=True, to=orm['blog.Location']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlogPost.location'
        db.delete_column(u'blog_blogpost', 'location_id')
