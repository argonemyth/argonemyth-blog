...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogCategory.position'
        db.add_column(u'blog_blogcategory', 'position',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlogCategory.position'
        db.delete_column(u'blog_blogcategory', 'position')
