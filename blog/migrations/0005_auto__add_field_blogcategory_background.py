...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogCategory.background'
        db.add_column(u'blog_blogcategory', 'background',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlogCategory.background'
        db.delete_column(u'blog_blogcategory', 'background')
