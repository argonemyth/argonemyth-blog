...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'blog_blogpost', (
            ...
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='blogposts', to=orm['auth.User'])),
            ...
            ('date_expired', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
